  ...
  const settingsOptions = [
    {
      ...
      description: 'Customize logos, colors, and the overall look of your church platform.',
    ...
    {
      title: 'Custom Domain',
      description: 'Connect your own domain (e.g. connect.mychurch.com) for a full white-label experience.',
      icon: <Globe size={24} />,
      href: '/hq/settings/domain',
      color: 'var(--purple)'
    },
    {
      ...
      icon: <Users size={24} />,
      href: '/hq/manage-church', // Reuse the branch/admin management
      color: 'var(--green)'
    }
  ];
  ...
  return (
    <div className="hq-dashboard">
      <div className="page-header">
        ...
        <p>Configure your church network's global preferences and white-labeling.</p>
      </div>
      ...
      <div className="settings-footer-info">
        <Card className="info-banner-card">
          ...
          <div className="banner-text">
            ...
            <p>Your church network is currently synced across all 4 branches.</p>
          </div>
