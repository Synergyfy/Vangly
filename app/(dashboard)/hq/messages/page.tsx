...
export default function HQMessagingPage() {
  ...
  const [messagingMode, setMessagingMode] = useState<'strict' | 'flexible' | 'open'>('flexible');

  const [templates, setTemplates] = useState([
    { id: 't1', name: 'First Contact', subject: 'Welcome to [Church Name]', content: 'Hi [Name], we are so glad you joined us today at [Church Name]! We hope you had a great time.' },
    { id: 't2', name: 'Follow-up', subject: 'We missed you!', content: 'Hello [Name], we missed you at service today. Hope everything is well. [Worker Name] from [Church Name].' },
    { id: 't3', name: 'Service Reminder', subject: 'See you tomorrow', content: 'Hey [Name]! Just a reminder that service starts at 9AM tomorrow. See you there!' },
  ]);
  ...
  const handleSaveTemplate = () => {
    if (currentTemplate) {
      setTemplates(templates.map(t => t.id === currentTemplate.id ? { ...t, ...templateForm } : t));
    } else {
  ...
  const sentMessages = [
    { id: 'm1', to: 'All Workers', date: 'Oct 12, 10:30 AM', type: 'SMS', status: 'delivered' },
    { id: 'm2', to: 'Northside Branch', date: 'Oct 10, 02:15 PM', type: 'Email', status: 'sent' },
  ];
    ...
    <div className="hq-dashboard">
        ...
        <div className="modal-overlay">
          <Card className="modal-card-premium template-modal">
            <div className="modal-header">
              <h2>{currentTemplate ? 'Edit Template' : 'Create New Template'}</h2>
              <Button variant="ghost" size="sm" onClick={() => setIsEditingTemplate(false)}><Plus size={24} style={{ transform: 'rotate(45deg)' }} /></Button>
            </div>
            <div className="form-stack">
              ...
              <div className="modal-actions">
                <Button variant="outline" onClick={() => setIsEditingTemplate(false)}>Cancel</Button>
      ...
      <div className="page-header flex-between">
        <div className="header-main">
          ...
          <p>Send broadcast updates and automated follow-ups across your network.</p>
        </div>
          ...
          <div className="compose-grid">
              ...
              <div className="compose-form">
                ...
                <div className="form-group-premium">
                  ...
                  <div className="channel-toggle">
                    <button className={messageType === 'sms' ? 'active' : ''} onClick={() => setMessageType('sms')}>
                      <MessageSquare size={16} /> SMS
                    </button>
                    <button className={messageType === 'email' ? 'active' : ''} onClick={() => setMessageType('email')}>
                      <Mail size={16} /> Email
                    </button>
                  </div>
                </div>
                ...
                <div className="form-group-premium">
                  ...
                  <textarea 
                    ...
                    className="message-textarea"
                    rows={8}
                    defaultValue={selectedTemplate !== 'none' ? templates.find(t => t.id === selectedTemplate)?.content : ''}
                  />
            ...
            <div className="compose-side-panels">
              ...
              <Card className="placeholder-tips-card">
                <h3><Type size={16} /> Placeholders</h3>
                ...
                <tbody>
                  {sentMessages.map(msg => (
                    <tr key={msg.id} className="user-row">
                      ...
                      <td>{msg.date}</td>
                      <td><span className="role-pill worker">{msg.type}</span></td>
                      <td><span className="status-indicator active">{msg.status}</span></td>
          ...
          <div className="templates-management-grid">
            <div className="templates-list-side">
              <div className="section-header-flex" style={{ marginBottom: '20px' }}>
                ...
                <Button size="sm" variant="outline" onClick={handleNewTemplate}><Plus size={16} /> New</Button>
              </div>
                ...
                {templates.map(t => (
                  <Card key={t.id} className="template-mini-card">
                    ...
                    <div className="template-actions">
                      <Button variant="ghost" size="sm" onClick={() => handleEditTemplate(t)}><Edit3 size={16} /></Button>
                      <Button variant="ghost" size="sm" className="text-danger" onClick={() => handleDeleteTemplate(t.id)}><Trash2 size={16} /></Button>
                    </div>
                  </Card>
                ))}
              </div>
            ...
            <div className="template-settings-side">
              <Card className="messaging-mode-card">
                <h3><Shield size={18} /> Messaging Restrictions</h3>
                <p className="hint-text">Control how workers can use these templates when following up with their contacts.</p>
                ...
                <div className="mode-options-stack">
                  ...
                  >
                    ...
                    <div className="mode-text">
                      ...
                      <span>Workers can ONLY send these exact templates. No editing allowed.</span>
                    </div>
                  </div>
                  ...
                  >
                    ...
                    <div className="mode-text">
                      ...
                      <span>Workers can use templates and make minor edits before sending.</span>
                    </div>
                  ...
                  >
                    ...
                    <div className="mode-text">
                      ...
                      <span>Workers can write completely custom messages from scratch.</span>
                    </div>
                  </div>
                </div>

                <Button fullWidth className="btn-premium" style={{ marginTop: '24px' }}>Save System Settings</Button>
              </Card>

              <Card className="placeholder-guide-card" style={{ marginTop: '24px' }}>
                <h3>How to use Placeholders</h3>
                <p>Templates support dynamic data. Use these tags in your content:</p>
                <ul className="placeholder-list">
                  <li><code>[Name]</code> - The Guest's Name</li>
                  <li><code>[Church Name]</code> - Your Church's Name</li>
                  <li><code>[Worker Name]</code> - The Worker's Name</li>
                </ul>
              </Card>
            </div>
          </div>
