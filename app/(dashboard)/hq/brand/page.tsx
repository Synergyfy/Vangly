    ...
    <div className="hq-dashboard">
      ...
      <div className="brand-grid">
        <div className="brand-config">
          <Card className="brand-card">
            <div className="card-section">
              <h2 className="section-title"><ImageIcon size={18} /> Church Logo</h2>
              <div className="logo-upload-area">
                ...
                <div className="logo-upload-controls">
                  ...
                  <p className="upload-hint">Recommended: Square PNG with transparent background.</p>
                </div>
              </div>
            </div>

            <div className="card-section">
              <h2 className="section-title"><Palette size={18} /> Visual Identity</h2>
            ...
            <div className="card-footer">
              <Button 
                ...
                className="save-btn"
              >
                {isSaving ? 'Applying Changes...' : (
                  <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                    {showSuccess ? <Check size={18} /> : <Save size={18} />}
                    {showSuccess ? 'Saved Successfully!' : 'Save Brand Settings'}
                  </div>
                )}
              </Button>
            </div>
        ...
        <div className="brand-preview">
          <h3>Live Preview</h3>
          <div className="preview-container" style={{ '--preview-primary': primaryColor, '--preview-accent': accentColor } as any}>
            <Card className="preview-sample-card">
              <div className="preview-topbar">
                <div className="preview-logo-tiny">
                  {logoPreview ? <img src={logoPreview} alt="" /> : '⛪'}
                </div>
                <div className="preview-name-tiny">{churchName || 'Your Church'}</div>
              </div>
